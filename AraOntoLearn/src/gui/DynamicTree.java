...
public class DynamicTree extends JPanel
{
	...
	public DynamicTree( String sRoot, String[] sIcons, boolean bShow ) {
		...
		Icon openIcon = AraOntoLearn.createImageIcon( sIcons[1] );
		Icon closedIcon = AraOntoLearn.createImageIcon( sIcons[0] );
		Icon leafIcon = AraOntoLearn.createImageIcon( sIcons[2] );
