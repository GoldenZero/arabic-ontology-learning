...
public class EvidenceManager implements Serializable {
	 ...
	 * @see evidence.EvidenceManager#getLocalStoreWrapper(AbstractAlgorithm owner, Class cStoreClass, int id)
	 * @see evidence.EvidenceManager#getNwrapperLocalStoreWrapper(AbstractAlgorithm owner, Class cStoreClass)
