 ...
 */
public class temp_AlgorithmsParser extends DefaultHandler {
	...
	private boolean insideAlgorithm;
	private boolean insideRelation;
	...
	public temp_AlgorithmsParser( File file ) {
		m_patternFile = file;
	}
	...
	/*	String sAlgorithmsXML = Settings.get( Settings.ALGORITHMS_XML );
		AlgorithmsParser parser = new AlgorithmsParser( new File( sAlgorithmsXML ) );
