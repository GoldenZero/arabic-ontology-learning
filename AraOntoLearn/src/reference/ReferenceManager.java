...
public class ReferenceManager implements Serializable {
	 ...
	 * @see reference.ReferenceManager#getLocalStoreWrapper(AbstractAlgorithm owner, Class cStoreClass, int id)
	 * @see reference.ReferenceManager#getNwrapperLocalStoreWrapper(AbstractAlgorithm owner, Class cStoreClass)
